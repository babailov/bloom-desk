/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d93a7d21b3f6956631628d589f0c46f9)
// Runtime types generated with workerd@1.20260908.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	ACCESS_TEAM_DOMAIN: "nbabailov.cloudflareaccess.com";
	ACCESS_ALLOWED_EMAILS: "nbabailov@gmail.com";
	ACCESS_AUD: "4ece4cc9818dae263c1bbe11ba245a427e705643f0f7a37d96c3da1b03834e27";
	CYCLE_WORKFLOW: Workflow<Parameters<import("./src/index").CycleWorkflow['run']>[0]['payload']>;
	MACRO_HISTORY_WORKFLOW: Workflow<Parameters<import("./src/index").MacroHistoryWorkflow['run']>[0]['payload']>;
	REFS_HISTORY_WORKFLOW: Workflow<Parameters<import("./src/index").RefsHistoryWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_TEAM_DOMAIN" | "ACCESS_ALLOWED_EMAILS" | "ACCESS_AUD">> {}
}
